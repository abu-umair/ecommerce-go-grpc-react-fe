import { ORDER_STATUS_CANCELLED, ORDER_STATUS_DONE, ORDER_STATUS_EXPIRED, ORDER_STATUS_PAID, ORDER_STATUS_SHIPPED, ORDER_STATUS_UNPAID } from '../../constants/order';
...
function OrderStatusBadge(props: OrderStatusBadgeProps) {
    ...
    return (
        <span
            //? yang dinamis adl backgroundColor dan textColor, dan name
            style={{
