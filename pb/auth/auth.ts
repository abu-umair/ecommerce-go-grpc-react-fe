...
/**
 * ?RegisterRequest = FormRequest di Laravel (buat validasi).
 *
...
// ? Ini persis kayak kamu bikin RegisterRequest.php di Laravel:
...
/**
 * ? RegisterResponse = JsonResponse atau Resource di Laravel (buat return response).
 *
