...
export interface CreateProductRequest {
     ...
     */
    price: number; // ? price hanya bisa diisi dengan angka positif (diatas 0)
    /**
...
/**
 * ? request edit product mirip sepertei field di CreateProductRequest( hanya saja ada ID nya )
 *
